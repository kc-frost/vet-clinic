...
function buildListItems(
	items: AnalyticsListItem[] | CancellationCategoryItem[],
	labelBuilder: (item: any) => string
) {
	if (!items.length) {
		return <p className="adminAnalyticsEmptyText">No data yet</p>;
	}
...
function ReviewExtremeCard({
	title,
	review,
}: {
	title: string;
	review: ReviewExtreme | null;
}) {
	return (
		<div className="adminAnalyticsListCard">
			...
			{review ? (
				<div className="adminAnalyticsReviewExtreme">
					...
					<p>
						<strong>Reason:</strong> {review.reasonKey}
					</p>
					<p>
					...
					{review.petName ? (
						<p>
							<strong>Pet:</strong> {review.petName}
						</p>
					) : null}
					{review.customerName ? (
						<p>
...
export default function AdminAnalytics() {
	...
	const topAppointmentTypeItems = useMemo(
		() => analytics?.topThreeRequestedItemsThisMonth || [],
		[analytics]
	);

	const topStaffItems = useMemo(
		() => analytics?.topThreeStaffThisMonth || [],
		[analytics]
	);

	const topUserItems = useMemo(
		() => analytics?.topThreeUsersThisMonth || [],
		[analytics]
	);

	const cancelCategoryItems = useMemo(
		() => analytics?.cancellationsThisMonthByCategory || [],
		[analytics]
	);
	...
	if (error || !analytics) {
		return (
			<div className="adminAnalyticsPage">
				...
				<p className="adminAnalyticsMessageError">
	...
	return (
		<div className="adminAnalyticsPage">
			<div className="adminAnalyticsHeader">
				<h1 className="adminAnalyticsTitle">View Analytics</h1>
				<p className="adminAnalyticsSubtitle">
					Admin appointment analytics and user review metrics
				</p>
			</div>

			<div className="adminAnalyticsStatsGrid">
				<div className="adminAnalyticsCard">
					<h2 className="adminAnalyticsMetricLabel">
						All Time Registered Users
					</h2>
					<p className="adminAnalyticsMetricValue">
						{analytics.allTimeRegisteredUsers}
					</p>
				</div>
				...
				<div className="adminAnalyticsCard">
					...
					<p className="adminAnalyticsMetricValue">
						{analytics.allTimeReservations}
					</p>
				</div>

				<div className="adminAnalyticsCard">
					<h2 className="adminAnalyticsMetricLabel">
						Appointments Made This Month
					</h2>
					<p className="adminAnalyticsMetricValue">
						{analytics.reservationsMadeThisMonth}
					</p>
				</div>
				...
				<div className="adminAnalyticsCard">
					...
					<p className="adminAnalyticsMetricValue">
						{analytics.uniqueUsersThisMonth}
					</p>
				</div>
				...
				<div className="adminAnalyticsCard">
					...
					<p className="adminAnalyticsMetricValue">
						{analytics.cancellationsThisMonth}
					</p>
				</div>
				...
				<div className="adminAnalyticsCard">
					...
					<p className="adminAnalyticsMetricValue">
						{formatRating(analytics.allTimeAverageRating)}
					</p>
				</div>
				...
				<div className="adminAnalyticsCard">
					...
					<p className="adminAnalyticsMetricValue">
						{formatRating(analytics.monthlyAverageRating)}
					</p>
				</div>
			</div>
			...
			<div className="adminAnalyticsListsGrid">
				<div className="adminAnalyticsListCard">
					<h2 className="adminAnalyticsListTitle">
						Top Three Appointments Made This Month
					</h2>
					{buildListItems(
						topAppointmentTypeItems,
				...
				<div className="adminAnalyticsListCard">
					<h2 className="adminAnalyticsListTitle">
						Cancellations This Month By Category
					</h2>
					{buildListItems(
						cancelCategoryItems,
						(item) => `${formatCancelCategory(item.category)} (${item.count})`
					)}
				</div>

				<ReviewExtremeCard
					title="Highest Scoring Reservation This Month"
					review={analytics.highestScoringReservationOfMonth}
				/>

				<ReviewExtremeCard
					title="Lowest Scoring Reservation This Month"
					review={analytics.lowestScoringReservationOfMonth}
				/>
			</div>
		</div>
	);
